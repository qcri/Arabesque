...
public class UPSDomainStorage extends Storage<UPSDomainStorage> {
    ...
    public UPSDomainStorage(int numberOfDomains) {
...
/*    public long getNumberSpuriousEmbeddings() {
     ...
     */
    @Override
    public void aggregate(UPSDomainStorage otherBasicDomainStorage) {
