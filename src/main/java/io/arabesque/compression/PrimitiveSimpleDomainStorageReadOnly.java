...
public class PrimitiveSimpleDomainStorageReadOnly extends PrimitiveSimpleDomainStorage {
    private static final Logger LOG = Logger.getLogger(PrimitiveSimpleDomainStorageReadOnly.class);
    ...
    private void initStorage() {
        ...
        for(int i = 0 ; i < numberOfDomains ; ++ i) {
            ...
            int[] keysSet = domainEntries.get(i).keySet().toIntArray();
